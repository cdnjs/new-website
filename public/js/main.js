  ...
  function displayMatchingLibraries(err, content) {
    ...
    var tempText2 =
      ...
      '<a href="' +
        ...
        ' Please don\'t forget to <a href="https://github.com/cdnjs/cdnjs/issues?utf8=%E2%9C%93&q=' + libraryName + '" target="_blank">search if there is already an issue for it</a> before adding a request.' +
      '</td>';
    html += tempText2;
